...
|--|--|--|--|
|Tarea 07|Alexa Skills|7|Activa|

## Lista de herramientas
1️⃣ Amazon Developer
...
## Objetivo
Desarrollar una skill para Alexa que se integre con una API externa OpenWeatherMap, para proporcionar información en tiempo real sobre el clima y pronósticos personalizados de una ciudad.

## Objetivos especificos
- Integrar la API de OpenWeatherMap para obtener datos climáticos en tiempo real.

- Adaptar las respuestas basadas en la ubicación, preferencias e Inttens del usuario para ofrecer información precisa.

- Probar la funcionalidad de la skill para asegurar respuestas precisas.
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = 'Esta es la skill hecha por: Myriam Valderrabano Cortes, ¿qué necesitas?';
...
const WeatherIntentHandler = {
  ...
  async handle(handlerInput) {
    try {
      const apiKey = 'c18ea6c83e8261dbbe2c5536fa513e71'; // Reemplaza con tu clave de API de OpenWeatherMap
      const lat = 20.252542; // Reemplaza con la latitud deseada
      const lon = -97.886920; // Reemplaza con la longitud deseada
